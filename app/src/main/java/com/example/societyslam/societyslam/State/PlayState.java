...
public class PlayState extends State implements OnClickListener {
    ...
    SocietyCard boxingSociety = new SocietyCard("Boxing Society", 0, 0, 3, 2, 120, R.drawable.boxingsociety, "Force Punce", 1, 40, Type.fighting, Type.electric, Type.water, 2, Level.Basic);
    ...
    ArrayList<Card> deckOfCards = new ArrayList<>
            (Arrays.asList(computerSociety, boxingSociety, rowingSociety, waterEnergy, electricEnergy, earthEnergy));
